...
<div class="signin_top_nav_wrapper pure-u-1">
    ...
    <ul class="person_top_nav_bar">
		<li class="pure-menu-item"><img class="nav_user pure-img" src="<%=request.getContextPath()%>/static/neu/images/girl-1252997_960_720.jpg" /></li>
    	...
    	<li class="pure-menu-item"><a href="<%=request.getContextPath()%>/schedule" class="pure-menu-link <% if("schedule".equals(request.getParameter("tab") ) ) {%>sel<%} %>">约课</a></li>
