...
<div class="home_main_content_wrapper home_s_main_content_wrapper pure-u-1  pure-g">
    ...
    <div class="home_t_main_content_banner_selbox pure-u-20-24 pure-u-xl-1">
    	<div class="home_main_content_banner_sel pure-u-1 pure-u-xl-1-2">
            <div class="signin_main_content">
                <div class="sign_link">
                    <span>已有账户？ </span>
                    <a href="signin-s.html">登录</a>
                </div>
                <form class="pure-form pure-form-aligned">
                    <div class="pure-control-group">
                        <label for="name">手机号</label>
                        <input id="aligned-name" class="username" type="text" placeholder="请输入手机号码作为您的登录账号">
                        <span class="pure-form-message-inline" style="display:none;">您输入的用户名不符合规范</span>
                    </div>
                    <div class="pure-control-group">
                        <label for="password">密码</label>
                        <input id="password" type="password" placeholder="请输入6～14位数字或英文的密码，不含空格">
                        <span class="pure-form-message-inline">您输入的密码不符合规范</span>
                    </div>
                    <div class="pure-control-group">
                        <label for="email">Email</label>
                        <input id="email" type="email" placeholder="请输入您的Email">
                        <span class="pure-form-message-inline">您输入的邮箱格式不符合规范</span>
                    </div>
                    <div class="pure-control-group">
                        <label for="password">手机验证码</label>
                        <input id="password" type="password" placeholder="请输入手机验证码">
                        <a href="#" class="phone-code">发送验证码</a>
                        <span class="pure-form-message-inline">验证码不正确</span>
                    </div>
                    <div class="pure-controls">
                        <label for="cb" class="pure-checkbox">
                            <input id="cb" type="checkbox">我已阅读并同意
                            <a href="#">《NeuABC协议》</a>
                        </label>
                        <a href="#" class="big-link" data-reveal-id="myModal">
                        <button type="submit" class="pure-button pure-button-primary sign_button" >注册</button>
                        </a>
                    </div>
                </form>
            </div>
...
<div class="home_t_aim_content_wrapper pure-u-1 pure-g">
    	...
    	<div class="aim_box  student_aim_box pure-u-22-24 pure-u-lg-1-6 pure-u-sm-6-24">
        	<div class="aim_img_blue"><span class="student_aim_img_1"></span></div>
        	<div class="student_aim_con">
                <h1><span class="">高资历</span>北美外教</h1>
    	...
    	<div class="aim_box student_aim_box pure-u-22-24 pure-u-lg-1-6 pure-u-sm-6-24">
        	<div class="aim_img_orange"><span class="student_aim_img_2"></span></div>
        	<div class="student_aim_con">
                <h1><span class="">1对1</span>定制化服务</h1>
                <p>北美外教1对1，打造适合中国本土小朋友的美国小学课程，因材施教。专业班主任老师一对一，全程提供五星服务，为孩子和家长及时解决各种问题，有效提升学习效果。</p>
            </div>
        </div>
    	<div class=" pure-u-1-24 pure-u-lg-1-12 pure-u-sm-1-24"></div>
    	<div class="aim_box student_aim_box pure-u-22-24 pure-u-lg-1-6 pure-u-sm-6-24">
        	<div class="aim_img_green"><span class="student_aim_img_3"></span></div>
        	<div class="student_aim_con">
                <h1><span class="">随时随地</span>便捷上课</h1>
...
<div class="home_student_class_wrapper pure-u-1 pure-g">
	...
	<div class="s_class_con pure-u-20-24 pure-u-sm-9-24">
    	<h1>全匹配式课程设计<br />量需定制，乐享学习</h1>
    	<p>你对语言学习的需求，将拆解成主题、程度、课程形式、外籍顾问、同学等众多面向，精准匹配，同时记录并分析每次的学习轨迹数据，为您提供直观反馈并优化下一次的学习体验。</p>
        <a href="#">了解更多上课流程&nbsp;></a>
    </div>
	<img class="s_class_bg pure-u-22-24 pure-u-sm-9-24" src="images/student_pad.png" />
	...
	<div class="pure-u-22-24 pure-u-md-2-3 pure-u-sm-20-24">
    	...
    	<div class="student_dialogs pure-u-1">
        	<div class="student_left pure-u-1-8">
            	<img class="img pure-img" src="images/girl-1252997_960_720.jpg" />
            </div>
            <div class="pure-u-7-8">
                <div class="student_right">
                    <p class="dialogs_text">
					"NeuABC 是21世纪的中国教育国际化的一个深受家长欢迎和孩子喜爱的崭新而有效的实验。她通过互联网连接北美的优秀老师与中国的孩子们，为中国孩子打开了一条宽广而前途无限的通道！"
                    </p>
                </div>
            </div>
    	</div>
